...
export default function Btn({ name, link }: BtnProps) {
  return (
    ...
    <Link href={link} target="_blank" className="flex flex-row bg-white hover:bg-[#fafafa] border border-black px-6 py-3 md:px-6 md:py-4 rounded-full items-center gap-2 md:gap-3">
