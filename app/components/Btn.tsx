...
export default function Btn({ name, link }: BtnProps) {
  return (
    <Link href={link} className="flex flex-row bg-black hover:bg-[#121111] text-white px-6 py-3 md:px-6 md:py-4 rounded-full items-center gap-2 md:gap-3 justify-center">
